...
Machine-readable Definition of Ready.
...
`dor.json` must be generated or validated by deterministic rules.

The model that generated the contract must not be the sole judge of whether the contract is ready.
...
```text
[PASS] intent.md exists
[PASS] in-scope section exists
[PASS] out-of-scope section exists
[PASS] constraints.md exists
[PASS] acceptance.feature exists
[PASS] >= 1 primary scenario
[PASS] >= 2 counterexamples
[PASS] no vague assertions
[PASS] no unresolved blockers
[PASS] dor.json schema valid
```
...
## 22. Initial CLI Surface

```bash
amigos init
amigos create STORY-123
amigos check STORY-123
amigos lint STORY-123
```
