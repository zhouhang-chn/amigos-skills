...
| v0.4 | Product, Development and QA as independent subagents | v0.3 | A run records one findings record per role and a computed count of findings named by exactly one role, and that count is greater than zero. | In progress |
